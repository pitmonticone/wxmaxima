...
bool AutoComplete::LoadBuiltinSymbols() {
  ...
  m_wordList[unit].push_back(wxS("A"));                                      // OPTION
  m_wordList[unit].push_back(wxS("acre"));                                   // OPTION
  m_wordList[unit].push_back(wxS("amp"));                                    // OPTION
  m_wordList[unit].push_back(wxS("ampere"));                                 // OPTION
  m_wordList[unit].push_back(wxS("astronomical_unit"));                      // OPTION
  m_wordList[unit].push_back(wxS("AU"));                                     // OPTION
  m_wordList[unit].push_back(wxS("becquerel"));                              // OPTION
  m_wordList[unit].push_back(wxS("Bq"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Btu"));                                    // OPTION
  m_wordList[unit].push_back(wxS("C"));                                      // OPTION
  m_wordList[unit].push_back(wxS("candela"));                                // OPTION
  m_wordList[unit].push_back(wxS("cfm"));                                    // OPTION
  m_wordList[unit].push_back(wxS("cm"));                                     // OPTION
  m_wordList[unit].push_back(wxS("coulomb"));                                // OPTION
  m_wordList[unit].push_back(wxS("cup"));                                    // OPTION
  m_wordList[unit].push_back(wxS("day"));                                    // OPTION
  m_wordList[unit].push_back(wxS("F"));                                      // OPTION
  m_wordList[unit].push_back(wxS("fA"));                                     // OPTION
  m_wordList[unit].push_back(wxS("farad"));                                  // OPTION
  m_wordList[unit].push_back(wxS("fC"));                                     // OPTION
  m_wordList[unit].push_back(wxS("feet"));                                   // OPTION
  m_wordList[unit].push_back(wxS("fF"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fg"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fH"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fHz"));                                    // OPTION
  m_wordList[unit].push_back(wxS("fJ"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fK"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fl_oz"));                                  // OPTION
  m_wordList[unit].push_back(wxS("fluid_ounce"));                            // OPTION
  m_wordList[unit].push_back(wxS("fm"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fmol"));                                   // OPTION
  m_wordList[unit].push_back(wxS("fN"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fOhm"));                                   // OPTION
  m_wordList[unit].push_back(wxS("foot"));                                   // OPTION
  m_wordList[unit].push_back(wxS("fPa"));                                    // OPTION
  m_wordList[unit].push_back(wxS("fs"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fS"));                                     // OPTION
  m_wordList[unit].push_back(wxS("ft"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fT"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fV"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fW"));                                     // OPTION
  m_wordList[unit].push_back(wxS("fWb"));                                    // OPTION
  m_wordList[unit].push_back(wxS("g"));                                      // OPTION
  m_wordList[unit].push_back(wxS("GA"));                                     // OPTION
  m_wordList[unit].push_back(wxS("gallon"));                                 // OPTION
  m_wordList[unit].push_back(wxS("GC"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GF"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Gg"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GH"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GHz"));                                    // OPTION
  m_wordList[unit].push_back(wxS("gill"));                                   // OPTION
  m_wordList[unit].push_back(wxS("GJ"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GK"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Gm"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Gmol"));                                   // OPTION
  m_wordList[unit].push_back(wxS("GN"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GOhm"));                                   // OPTION
  m_wordList[unit].push_back(wxS("GPa"));                                    // OPTION
  m_wordList[unit].push_back(wxS("grain"));                                  // OPTION
  m_wordList[unit].push_back(wxS("gram"));                                   // OPTION
  m_wordList[unit].push_back(wxS("gray"));                                   // OPTION
  m_wordList[unit].push_back(wxS("Gs"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GS"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GT"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GV"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GW"));                                     // OPTION
  m_wordList[unit].push_back(wxS("GWb"));                                    // OPTION
  m_wordList[unit].push_back(wxS("Gy"));                                     // OPTION
  m_wordList[unit].push_back(wxS("H"));                                      // OPTION
  m_wordList[unit].push_back(wxS("ha"));                                     // OPTION
  m_wordList[unit].push_back(wxS("hectare"));                                // OPTION
  m_wordList[unit].push_back(wxS("henry"));                                  // OPTION
  m_wordList[unit].push_back(wxS("hertz"));                                  // OPTION
  m_wordList[unit].push_back(wxS("horsepower"));                             // OPTION
  m_wordList[unit].push_back(wxS("hour"));                                   // OPTION
  m_wordList[unit].push_back(wxS("hp"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Hz"));                                     // OPTION
  m_wordList[unit].push_back(wxS("inch"));                                   // OPTION
  m_wordList[unit].push_back(wxS("J"));                                      // OPTION
  m_wordList[unit].push_back(wxS("joule"));                                  // OPTION
  m_wordList[unit].push_back(wxS("julian_year"));                            // OPTION
  m_wordList[unit].push_back(wxS("K"));                                      // OPTION
  m_wordList[unit].push_back(wxS("kA"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kat"));                                    // OPTION
  m_wordList[unit].push_back(wxS("katal"));                                  // OPTION
  m_wordList[unit].push_back(wxS("kC"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kelvin"));                                 // OPTION
  m_wordList[unit].push_back(wxS("kF"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kg"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kH"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kHz"));                                    // OPTION
  m_wordList[unit].push_back(wxS("kilogram"));                               // OPTION
  m_wordList[unit].push_back(wxS("kilometer"));                              // OPTION
  m_wordList[unit].push_back(wxS("kJ"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kK"));                                     // OPTION
  m_wordList[unit].push_back(wxS("km"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kmol"));                                   // OPTION
  m_wordList[unit].push_back(wxS("kN"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kOhm"));                                   // OPTION
  m_wordList[unit].push_back(wxS("kPa"));                                    // OPTION
  m_wordList[unit].push_back(wxS("ks"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kS"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kT"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kV"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kW"));                                     // OPTION
  m_wordList[unit].push_back(wxS("kWb"));                                    // OPTION
  m_wordList[unit].push_back(wxS("l"));                                      // OPTION
  m_wordList[unit].push_back(wxS("lbf"));                                    // OPTION
  m_wordList[unit].push_back(wxS("lbm"));                                    // OPTION
  m_wordList[unit].push_back(wxS("light_year"));                             // OPTION
  m_wordList[unit].push_back(wxS("liter"));                                  // OPTION
  m_wordList[unit].push_back(wxS("lumen"));                                  // OPTION
  m_wordList[unit].push_back(wxS("lux"));                                    // OPTION
  m_wordList[unit].push_back(wxS("m"));                                      // OPTION
  m_wordList[unit].push_back(wxS("mA"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MA"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mC"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MC"));                                     // OPTION
  m_wordList[unit].push_back(wxS("meter"));                                  // OPTION
  m_wordList[unit].push_back(wxS("metric_ton"));                             // OPTION
  m_wordList[unit].push_back(wxS("mF"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MF"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mg"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Mg"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mH"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MH"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mHz"));                                    // OPTION
  m_wordList[unit].push_back(wxS("MHz"));                                    // OPTION
  m_wordList[unit].push_back(wxS("microA"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microC"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microF"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microg"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microgram"));                              // OPTION
  m_wordList[unit].push_back(wxS("microH"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microHz"));                                // OPTION
  m_wordList[unit].push_back(wxS("microJ"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microK"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microm"));                                 // OPTION
  m_wordList[unit].push_back(wxS("micrometer"));                             // OPTION
  m_wordList[unit].push_back(wxS("micron"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microN"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microOhm"));                               // OPTION
  m_wordList[unit].push_back(wxS("microPa"));                                // OPTION
  m_wordList[unit].push_back(wxS("micros"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microS"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microsecond"));                            // OPTION
  m_wordList[unit].push_back(wxS("microT"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microV"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microW"));                                 // OPTION
  m_wordList[unit].push_back(wxS("microWb"));                                // OPTION
  m_wordList[unit].push_back(wxS("mile"));                                   // OPTION
  m_wordList[unit].push_back(wxS("minute"));                                 // OPTION
  m_wordList[unit].push_back(wxS("mJ"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MJ"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mK"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MK"));                                     // OPTION
  m_wordList[unit].push_back(wxS("ml"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mm"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Mm"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mmol"));                                   // OPTION
  m_wordList[unit].push_back(wxS("Mmol"));                                   // OPTION
  m_wordList[unit].push_back(wxS("mN"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MN"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mOhm"));                                   // OPTION
  m_wordList[unit].push_back(wxS("MOhm"));                                   // OPTION
  m_wordList[unit].push_back(wxS("mol"));                                    // OPTION
  m_wordList[unit].push_back(wxS("mole"));                                   // OPTION
  m_wordList[unit].push_back(wxS("month"));                                  // OPTION
  m_wordList[unit].push_back(wxS("mPa"));                                    // OPTION
  m_wordList[unit].push_back(wxS("MPa"));                                    // OPTION
  m_wordList[unit].push_back(wxS("ms"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mS"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Ms"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MS"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mT"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MT"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mV"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MV"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mW"));                                     // OPTION
  m_wordList[unit].push_back(wxS("MW"));                                     // OPTION
  m_wordList[unit].push_back(wxS("mWb"));                                    // OPTION
  m_wordList[unit].push_back(wxS("MWb"));                                    // OPTION
  m_wordList[unit].push_back(wxS("N"));                                      // OPTION
  m_wordList[unit].push_back(wxS("nA"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nC"));                                     // OPTION
  m_wordList[unit].push_back(wxS("newton"));                                 // OPTION
  m_wordList[unit].push_back(wxS("nF"));                                     // OPTION
  m_wordList[unit].push_back(wxS("ng"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nH"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nHz"));                                    // OPTION
  m_wordList[unit].push_back(wxS("nJ"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nK"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nm"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nmol"));                                   // OPTION
  m_wordList[unit].push_back(wxS("nN"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nOhm"));                                   // OPTION
  m_wordList[unit].push_back(wxS("nPa"));                                    // OPTION
  m_wordList[unit].push_back(wxS("ns"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nS"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nT"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nV"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nW"));                                     // OPTION
  m_wordList[unit].push_back(wxS("nWb"));                                    // OPTION
  m_wordList[unit].push_back(wxS("ohm"));                                    // OPTION
  m_wordList[unit].push_back(wxS("Ohm"));                                    // OPTION
  m_wordList[unit].push_back(wxS("ounce"));                                  // OPTION
  m_wordList[unit].push_back(wxS("oz"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pA"));                                     // OPTION
  m_wordList[unit].push_back(wxS("Pa"));                                     // OPTION
  m_wordList[unit].push_back(wxS("parsec"));                                 // OPTION
  m_wordList[unit].push_back(wxS("pascal"));                                 // OPTION
  m_wordList[unit].push_back(wxS("pc"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pC"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pF"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pg"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pH"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pHz"));                                    // OPTION
  m_wordList[unit].push_back(wxS("pint"));                                   // OPTION
  m_wordList[unit].push_back(wxS("pJ"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pK"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pm"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pmol"));                                   // OPTION
  m_wordList[unit].push_back(wxS("pN"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pOhm"));                                   // OPTION
  m_wordList[unit].push_back(wxS("pound_force"));                            // OPTION
  m_wordList[unit].push_back(wxS("pound_mass"));                             // OPTION
  m_wordList[unit].push_back(wxS("pPa"));                                    // OPTION
  m_wordList[unit].push_back(wxS("ps"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pS"));                                     // OPTION
  m_wordList[unit].push_back(wxS("psi"));                                    // OPTION
  m_wordList[unit].push_back(wxS("pT"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pV"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pW"));                                     // OPTION
  m_wordList[unit].push_back(wxS("pWb"));                                    // OPTION
  m_wordList[unit].push_back(wxS("quart"));                                  // OPTION
  m_wordList[unit].push_back(wxS("R"));                                      // OPTION
  m_wordList[unit].push_back(wxS("rod"));                                    // OPTION
  m_wordList[unit].push_back(wxS("s"));                                      // OPTION
  m_wordList[unit].push_back(wxS("S"));                                      // OPTION
  m_wordList[unit].push_back(wxS("second"));                                 // OPTION
  m_wordList[unit].push_back(wxS("short_ton"));                              // OPTION
  m_wordList[unit].push_back(wxS("siemens"));                                // OPTION
  m_wordList[unit].push_back(wxS("sievert"));                                // OPTION
  m_wordList[unit].push_back(wxS("slug"));                                   // OPTION
  m_wordList[unit].push_back(wxS("Sv"));                                     // OPTION
  m_wordList[unit].push_back(wxS("T"));                                      // OPTION
  m_wordList[unit].push_back(wxS("tablespoon"));                             // OPTION
  m_wordList[unit].push_back(wxS("tbsp"));                                   // OPTION
  m_wordList[unit].push_back(wxS("teaspoon"));                               // OPTION
  m_wordList[unit].push_back(wxS("tesla"));                                  // OPTION
  m_wordList[unit].push_back(wxS("tsp"));                                    // OPTION
  m_wordList[unit].push_back(wxS("V"));                                      // OPTION
  m_wordList[unit].push_back(wxS("volt"));                                   // OPTION
  m_wordList[unit].push_back(wxS("W"));                                      // OPTION
  m_wordList[unit].push_back(wxS("watt"));                                   // OPTION
  m_wordList[unit].push_back(wxS("Wb"));                                     // OPTION
  m_wordList[unit].push_back(wxS("weber"));                                  // OPTION
  m_wordList[unit].push_back(wxS("week"));                                   // OPTION
  m_wordList[unit].push_back(wxS("yard"));                                   // OPTION
  m_wordList[unit].push_back(wxS("year"));                                   // OPTION
